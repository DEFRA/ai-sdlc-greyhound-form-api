...
```bash
docker build --target development --no-cache --tag ai-sdlc-greyhound-form-api:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 ai-sdlc-greyhound-form-api:development
```
...
```bash
docker build --no-cache --tag ai-sdlc-greyhound-form-api .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 ai-sdlc-greyhound-form-api
```
